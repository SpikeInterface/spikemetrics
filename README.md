...
| L-ratio            |                          | The Mahalanobis distance and χ2 inverse cdf (given normality assumption of the cluster) used to find the probability of cluster membership for each spike |        Schmitzer-Torbert and Redish. _J Neurophy_  91.5 (2004): 2259-2272.         |
